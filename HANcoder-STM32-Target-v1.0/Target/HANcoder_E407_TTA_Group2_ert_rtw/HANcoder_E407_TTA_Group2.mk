...
MODEL                = HANcoder_E407_TTA_Group2
MODULES              = HANcoder_E407_TTA_Group2_data.c
MAKEFILE             = HANcoder_E407_TTA_Group2.mk
...
#|---------------------------------------------------------------------------------------
MODELLIB                  = HANcoder_E407_TTA_Group2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I"C:\Users\cheff\Documents\DS_MP_redundant_vehicle_control\HANcoder-STM32-Target-v1.0\Target\HANcoder_E407_TTA_Group2_ert_rtw" \
	-I"$(MATLAB_ROOT)\extern\include" \
	-I"$(MATLAB_ROOT)\simulink\include" \
	-I"$(MATLAB_ROOT)\rtw\c\src" \
