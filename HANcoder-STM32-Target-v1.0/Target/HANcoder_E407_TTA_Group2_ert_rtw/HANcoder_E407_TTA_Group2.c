...
real_T Master_ID_ing_s;                /* '<S517>/Data Store Read' */
real_T Role_ID_ing_s;                  /* '<S517>/Data Store Read1' */
real_T sync_bc1_miss_counter_ing;      /* '<S517>/Data Store Read3' */
real_T sync_bc0_miss_counter_ing;      /* '<S517>/Data Store Read4' */
real_T msg_count_DEBUG_ing_s;          /* '<S520>/Data Store Read24' */
real_T Desync_Sync_bc1_ing_s;          /* '<S640>/Saturation' */
real_T v_set_s;                        /* '<S592>/Constant12' */
real_T Desync_Sync_bc0_ing_s;          /* '<S551>/Saturation' */
...
real_T Desync_Sync_bc1_s;              /* '<S489>/Saturation' */
real_T rxDeltaA;                       /* '<S471>/Switch' */
real_T rxDeltaF;                       /* '<S470>/Switch' */
real_T rxSpeedV;                       /* '<S472>/Switch' */
...
boolean_T BC1_sync_processed_ing_s;    /* '<S517>/Data Store Read10' */
boolean_T BC0_sync_processed_ing_s;    /* '<S517>/Data Store Read2' */
boolean_T reset_ing_s;                 /* '<S522>/Data Store Read' */
...
boolean_T new_set_rx_s;                /* '<S441>/Data Store Read5' */
 ...
 *    '<S521>/Reception substasks'
 *    '<S580>/Reception substasks'
 *    '<S581>/Reception substasks'
 */
 ...
 *    '<S521>/Transmission subtasks'
 *    '<S581>/Transmission subtasks'
 */
 ...
 *    '<S518>/COMM Task - Sync bc 0'
 *    '<S519>/COMM Task - Sync bc 1'
 */
 ...
 *    '<S485>/Demux message CAN1 and check coherence'
 */
 ...
 *    '<S485>/Demux message CAN1 and check coherence1'
 */
 ...
 *    '<S389>/Reset Tx msg counter'
 *    '<S390>/Reset Tx msg counter'
 *    '<S524>/Reset Tx msg counter'
 *    '<S584>/Reset Tx msg counter'
 *    '<S585>/Reset Tx msg counter'
 */
 ...
 *    '<S515>/Desync_Negative'
 *    '<S577>/Desync_Negative'
 *    '<S666>/Desync_Negative'
 */
 ...
 *    '<S439>/Demux message CAN1 and check coherence'
 */
 ...
 *    '<S439>/Demux message CAN1 and check coherence1'
 */
...
/*
 * Disable for enable system:
 *    '<S393>/Check msg transmission CAN1'
 *    '<S588>/Check msg transmission CAN1'
 */
  ...
  *rtd_Tx_msg_count_CAN1, uint8_T *rtd_basic_cycle_count)
{
  ...
  /* Outputs for Enabled SubSystem: '<S393>/Check msg transmission CAN1' incorporates:
  ...
  if (rtu_Enable) {
    ...
    /* Sum: '<S395>/Minus2' incorporates:
     *  Constant: '<S395>/Constant'
     */
    rtb_Minus2_d = rtu_TimeMark + COMM_Phase_init1;

    /* Outputs for Enabled SubSystem: '<S395>/TX buffer update CAN1' incorporates:
     *  EnablePort: '<S398>/Enable'
     */
    /* RelationalOperator: '<S395>/Equal4' incorporates:
     *  Constant: '<S395>/Constant22'
     *  Constant: '<S395>/Constant24'
    ...
    if (rt_modd(((real_T)rtu_LocalTime + 1.0) - rtb_Minus2_d, COMM_Phase1) ==
        0.0) {
      /* DataTypeConversion: '<S398>/Cast4' */
      rtb_Cast4 = *rtd_basic_cycle_count;

      /* Outputs for Atomic SubSystem: '<S399>/Bit Shift1' */
      BitShift1(rtb_Cast4, &localB->BitShift1_g);

      /* End of Outputs for SubSystem: '<S399>/Bit Shift1' */

      /* DataTypeConversion: '<S398>/Cast1' */
      rtb_Cast1_j = (uint8_T)*rtd_Tx_msg_count_CAN1;

      /* Outputs for Atomic SubSystem: '<S399>/Bit Shift' */
      BitShift4(rtb_Cast1_j, &localB->BitShift_h);

      /* End of Outputs for SubSystem: '<S399>/Bit Shift' */

      /* DataStoreWrite: '<S398>/Data Store Write10' incorporates:
       *  DataTypeConversion: '<S398>/Cast16'
       *  Sum: '<S399>/Minus'
       */
      rtd_Msg_Tx_CAN1->Buffer_1 = (uint8_T)((uint32_T)(uint8_T)((uint32_T)
      ...
      /* DataStoreWrite: '<S398>/Data Store Write8' */
      *rtd_TxID_CAN1 = localC->Cast;
    }

    /* End of RelationalOperator: '<S395>/Equal4' */
    /* End of Outputs for SubSystem: '<S395>/TX buffer update CAN1' */

    /* RelationalOperator: '<S395>/Equal7' incorporates:
     *  Constant: '<S395>/Constant11'
     *  Constant: '<S395>/Constant27'
     *  Math: '<S395>/Mod1'
     *  Sum: '<S395>/Minus1'
     */
  ...
  /* End of Outputs for SubSystem: '<S393>/Check msg transmission CAN1' */
}

/*
 * Disable for enable system:
 *    '<S393>/Check msg transmission CAN2'
 *    '<S588>/Check msg transmission CAN2'
 */
void CheckmsgtransmissionC_d_Disable(rtB_CheckmsgtransmissionCAN2 *localB,
  rtDW_CheckmsgtransmissionCAN2 *localDW)
{
  /* Disable for Outport: '<S396>/Send CAN2' */
  localB->Equal7 = false;
  localDW->CheckmsgtransmissionCAN2_MODE = false;
}
  ...
  *rtd_Tx_msg_count_CAN2, uint8_T *rtd_basic_cycle_count)
{
  ...
  /* Outputs for Enabled SubSystem: '<S393>/Check msg transmission CAN2' incorporates:
  ...
  if (rtu_Enable) {
    ...
    /* Sum: '<S396>/Minus2' incorporates:
     *  Constant: '<S396>/Constant'
     */
    rtb_Minus2_l = rtu_TimeMark + COMM_Phase_init2;

    /* Outputs for Enabled SubSystem: '<S396>/TX buffer update CAN2' incorporates:
     *  EnablePort: '<S404>/Enable'
     */
    /* RelationalOperator: '<S396>/Equal4' incorporates:
    ...
    if (rt_modd(((real_T)rtu_LocalTime + 1.0) - rtb_Minus2_l, COMM_Phase2) ==
        0.0) {
      /* DataTypeConversion: '<S404>/Cast18' */
      rtb_Cast18 = *rtd_basic_cycle_count;

      /* Outputs for Atomic SubSystem: '<S405>/Bit Shift1' */
      BitShift1(rtb_Cast18, &localB->BitShift1_i);

      /* End of Outputs for SubSystem: '<S405>/Bit Shift1' */

      /* DataTypeConversion: '<S404>/Cast9' */
      rtb_Cast9 = (uint8_T)*rtd_Tx_msg_count_CAN2;

      /* Outputs for Atomic SubSystem: '<S405>/Bit Shift' */
      BitShift4(rtb_Cast9, &localB->BitShift_p);

      /* End of Outputs for SubSystem: '<S405>/Bit Shift' */

      /* DataStoreWrite: '<S404>/Data Store Write4' incorporates:
       *  DataTypeConversion: '<S404>/Cast17'
       *  Sum: '<S405>/Minus'
       */
      rtd_Msg_Tx_CAN2->Buffer_1 = (uint8_T)((uint32_T)(uint8_T)((uint32_T)
      ...
      /* DataStoreWrite: '<S404>/Data Store Write5' */
      *rtd_TxID_CAN2 = localC->Cast8;
    }

    /* End of RelationalOperator: '<S396>/Equal4' */
    /* End of Outputs for SubSystem: '<S396>/TX buffer update CAN2' */

    /* RelationalOperator: '<S396>/Equal7' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S393>/Check msg transmission CAN2' */
}

/*
 * Output and update for enable system:
 *    '<S388>/Reset Variables'
 *    '<S583>/Reset Variables'
 */
...
{
  /* Outputs for Enabled SubSystem: '<S388>/Reset Variables' incorporates:
   *  EnablePort: '<S438>/Enable'
   */
  if (rtu_Enable) {
    /* DataStoreWrite: '<S438>/Data Store Write' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S388>/Reset Variables' */
}

/*
 * Output and update for enable system:
 *    '<S391>/Local Time Update'
 *    '<S586>/Local Time Update'
 */
                     ...
                     boolean_T *rtd_Toggle_Pin_A0, boolean_T *rtd_Toggle_Pin_D10)
{
  ...
  /* Outputs for Enabled SubSystem: '<S391>/Local Time Update' incorporates:
   *  EnablePort: '<S515>/Enable'
   */
  if (rtu_Enable) {
    /* RelationalOperator: '<S515>/GreaterThan' incorporates:
    ...
    *rtd_Desync_Positive = (*rtd_Desync_Ticks > 0.0);
    ...
    /* Outputs for Enabled SubSystem: '<S515>/Desync_Negative' */
    Desync_Negative(rtb_NOT_ou, rtu_Time_Mark, rtd_Desync_Ticks, rtd_Local_Ticks);

    /* End of Outputs for SubSystem: '<S515>/Desync_Negative' */

    /* DataStoreWrite: '<S515>/Data Store Write13' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S391>/Local Time Update' */
}

/*
 * Disable for enable system:
 *    '<S547>/Demux message CAN1 and check coherence'
 *    '<S636>/Demux message CAN1 and check coherence'
 */
void DemuxmessageCAN1andc_ls_Disable(rtB_DemuxmessageCAN1andcheckc_a *localB,
  rtDW_DemuxmessageCAN1andcheck_k *localDW)
{
  /* Disable for Outport: '<S549>/CAN1_msg_coherent' */
  localB->Equal1 = false;
...
{
  /* Outputs for Enabled SubSystem: '<S547>/Demux message CAN1 and check coherence' incorporates:
  ...
  if (rtu_Enable) {
    ...
    /* Outputs for Atomic SubSystem: '<S552>/Bit Shift3' */
    BitShift3(rtu_CAN1_Rx_msg->Buffer_1, &localB->BitShift3_p);

    /* End of Outputs for SubSystem: '<S552>/Bit Shift3' */

    /* Outputs for Atomic SubSystem: '<S552>/Bit Shift1' */
    BitShift1_m(localB->BitShift3_p.y, &localB->BitShift1_b);

    /* End of Outputs for SubSystem: '<S552>/Bit Shift1' */
    ...
    /* SignalConversion: '<S549>/BusConversion_InsertedFor_CAN1_msg_at_inport_0' */
    localB->Buffer_2 = rtu_CAN1_Rx_msg->Buffer_2;
    ...
    /* Outputs for Atomic SubSystem: '<S552>/Bit Shift' */
    BitShift(rtu_CAN1_Rx_msg->Buffer_1, &localB->BitShift_a);

    /* End of Outputs for SubSystem: '<S552>/Bit Shift' */

    /* RelationalOperator: '<S549>/Equal1' */
    localB->Equal1 = (localB->BitShift_a.y == rtu_expected_basic_cycle);

    /* Outputs for Atomic SubSystem: '<S552>/Bit Shift4' */
    BitShift4(rtu_CAN1_Rx_msg->Buffer_1, &localB->BitShift4_n);

    /* End of Outputs for SubSystem: '<S552>/Bit Shift4' */

    /* Outputs for Atomic SubSystem: '<S552>/Bit Shift2' */
    BitShift2(localB->BitShift4_n.y, &localB->BitShift2_j);

    /* End of Outputs for SubSystem: '<S552>/Bit Shift2' */
  } else {
    if (localDW->DemuxmessageCAN1andcheckcohe_mm) {
  ...
  /* End of Outputs for SubSystem: '<S547>/Demux message CAN1 and check coherence' */
}

/*
 * Disable for enable system:
 *    '<S547>/Demux message CAN1 and check coherence1'
 *    '<S636>/Demux message CAN1 and check coherence1'
 */
void DemuxmessageCAN1andch_k_Disable(rtB_DemuxmessageCAN1andcheckc_i *localB,
  rtDW_DemuxmessageCAN1andcheck_b *localDW)
{
  /* Disable for Outport: '<S550>/CAN2_msg_coherent' */
  localB->Equal1 = false;
...
void DemuxmessageCAN1andcheckcoher_h(boolean_T rtu_Enable, const msg_buffer_type
  ...
  *localDW, real_T *rtd_msg_count_DEBUG)
{
  /* Outputs for Enabled SubSystem: '<S547>/Demux message CAN1 and check coherence1' incorporates:
  ...
  if (rtu_Enable) {
    ...
    /* Outputs for Atomic SubSystem: '<S564>/Bit Shift3' */
    BitShift3(rtu_CAN2_Rx_msg->Buffer_1, &localB->BitShift3_e);

    /* End of Outputs for SubSystem: '<S564>/Bit Shift3' */

    /* Outputs for Atomic SubSystem: '<S564>/Bit Shift1' */
    BitShift1_m(localB->BitShift3_e.y, &localB->BitShift1_d);

    /* End of Outputs for SubSystem: '<S564>/Bit Shift1' */

    /* Switch: '<S565>/Switch' incorporates:
     *  Constant: '<S565>/Constant'
     *  Constant: '<S565>/Constant1'
     *  RelationalOperator: '<S565>/GreaterThan'
     *  Sum: '<S565>/Plus'
     */
    ...
    /* SignalConversion: '<S550>/BusConversion_InsertedFor_CAN2_msg_at_inport_0' */
    localB->Buffer_2 = rtu_CAN2_Rx_msg->Buffer_2;
    ...
    /* Outputs for Atomic SubSystem: '<S564>/Bit Shift' */
    BitShift(rtu_CAN2_Rx_msg->Buffer_1, &localB->BitShift_k);

    /* End of Outputs for SubSystem: '<S564>/Bit Shift' */

    /* RelationalOperator: '<S550>/Equal1' */
    localB->Equal1 = (localB->BitShift_k.y == rtu_expected_basic_cycle);

    /* Outputs for Atomic SubSystem: '<S564>/Bit Shift4' */
    BitShift4(rtu_CAN2_Rx_msg->Buffer_1, &localB->BitShift4_k);

    /* End of Outputs for SubSystem: '<S564>/Bit Shift4' */

    /* Outputs for Atomic SubSystem: '<S564>/Bit Shift2' */
    BitShift2(localB->BitShift4_k.y, &localB->BitShift2_l);

    /* End of Outputs for SubSystem: '<S564>/Bit Shift2' */
  } else {
    if (localDW->DemuxmessageCAN1andcheckcohe_ek) {
  ...
  /* End of Outputs for SubSystem: '<S547>/Demux message CAN1 and check coherence1' */
}
  ...
  if (localDW->MatrixCycleManager_MODE) {
    ...
    if (localDW->ControllerMatrixCycle_MODE) {
      ...
      if (localDW->controllerbasiccycle1_MODE) {
        ...
        if (localDW->COMPTaskRx_Set_Values_Check_MOD) {
          /* Disable for Enabled SubSystem: '<S389>/Process_Messages' */
          if (localDW->Process_Messages_MODE_g) {
            /* Disable for Enabled SubSystem: '<S439>/Demux message CAN1 and check coherence' */
            ...
            /* End of Disable for SubSystem: '<S439>/Demux message CAN1 and check coherence' */

            /* Disable for Enabled SubSystem: '<S439>/Demux message CAN1 and check coherence1' */
            ...
            /* End of Disable for SubSystem: '<S439>/Demux message CAN1 and check coherence1' */
            localDW->Process_Messages_MODE_g = false;
          }

          /* End of Disable for SubSystem: '<S389>/Process_Messages' */
        ...
        if (localDW->COMPTaskSyncbc1check_MODE_g) {
          ...
          if (localDW->Process_Messages_MODE_j) {
            /* Disable for Enabled SubSystem: '<S485>/Demux message CAN1 and check coherence' */
            ...
            /* End of Disable for SubSystem: '<S485>/Demux message CAN1 and check coherence' */

            /* Disable for Enabled SubSystem: '<S485>/Demux message CAN1 and check coherence1' */
            ...
            /* End of Disable for SubSystem: '<S485>/Demux message CAN1 and check coherence1' */
        ...
        if (localDW->COMMTaskSet_Values_MODE_i) {
          ...
          if (localDW->Transmissionsubtasks_MODE_c) {
            /* Disable for Enabled SubSystem: '<S393>/Check msg transmission CAN1' */
            ...
            /* End of Disable for SubSystem: '<S393>/Check msg transmission CAN1' */

            /* Disable for Enabled SubSystem: '<S393>/Check msg transmission CAN2' */
            ...
            /* End of Disable for SubSystem: '<S393>/Check msg transmission CAN2' */

            /* Disable for Outport: '<S393>/Send CAN1' */
            localB->CheckmsgtransmissionCAN1_m.Equal7 = false;

            /* Disable for Outport: '<S393>/Send CAN2' */
    ...
    if (localDW->InputGeneratorMatrixCycle_MODE) {
      ...
      if (localDW->inputgeneratorbasiccycle0_MODE) {
        /* Disable for Enabled SubSystem: '<S518>/COMP Task - Sync bc0 check' */
        if (localDW->COMPTaskSyncbc0check_MODE) {
          /* Disable for Enabled SubSystem: '<S524>/Process_Messages' */
          if (localDW->Process_Messages_MODE_n) {
            /* Disable for Enabled SubSystem: '<S547>/Demux message CAN1 and check coherence' */
            ...
            /* End of Disable for SubSystem: '<S547>/Demux message CAN1 and check coherence' */

            /* Disable for Enabled SubSystem: '<S547>/Demux message CAN1 and check coherence1' */
            ...
            /* End of Disable for SubSystem: '<S547>/Demux message CAN1 and check coherence1' */
            localDW->Process_Messages_MODE_n = false;
          }

          /* End of Disable for SubSystem: '<S524>/Process_Messages' */
          localDW->COMPTaskSyncbc0check_MODE = false;
        }

        /* End of Disable for SubSystem: '<S518>/COMP Task - Sync bc0 check' */

        /* Disable for Enabled SubSystem: '<S518>/COMM Task - Sync bc 0' */
        ...
        /* End of Disable for SubSystem: '<S518>/COMM Task - Sync bc 0' */

        /* Disable for Outport: '<S518>/Send_Message_CAN1' */
        localB->COMMTaskSyncbc0_e.Transmissionsubtasks_l.Equal7_a = false;

        /* Disable for Outport: '<S518>/Send_Message_CAN2' */
        localB->COMMTaskSyncbc0_e.Transmissionsubtasks_l.Equal7 = false;

        /* Disable for Outport: '<S518>/Receive_Message_CAN1' */
        localB->COMMTaskSyncbc0_e.Receptionsubstasks_h.AND = false;

        /* Disable for Outport: '<S518>/Receive_Message_CAN2' */
      ...
      if (localDW->inputgeneratorbasiccycle1_MODE) {
        /* Disable for Enabled SubSystem: '<S519>/COMP Task - Sync bc1 check' */
        if (localDW->COMPTaskSyncbc1check_MODE) {
          /* Disable for Enabled SubSystem: '<S585>/Process_Messages' */
          if (localDW->Process_Messages_MODE) {
            /* Disable for Enabled SubSystem: '<S636>/Demux message CAN1 and check coherence' */
            ...
            /* End of Disable for SubSystem: '<S636>/Demux message CAN1 and check coherence' */

            /* Disable for Enabled SubSystem: '<S636>/Demux message CAN1 and check coherence1' */
            ...
            /* End of Disable for SubSystem: '<S636>/Demux message CAN1 and check coherence1' */
            localDW->Process_Messages_MODE = false;
          }

          /* End of Disable for SubSystem: '<S585>/Process_Messages' */
          localDW->COMPTaskSyncbc1check_MODE = false;
        }

        /* End of Disable for SubSystem: '<S519>/COMP Task - Sync bc1 check' */

        /* Disable for Enabled SubSystem: '<S519>/COMM Task - Set_Values' */
        if (localDW->COMMTaskSet_Values_MODE) {
          /* Disable for Enabled SubSystem: '<S580>/Reception substasks' */
          ...
          /* End of Disable for SubSystem: '<S580>/Reception substasks' */

          /* Disable for Enabled SubSystem: '<S580>/Transmission subtasks' */
          if (localDW->Transmissionsubtasks_MODE) {
            /* Disable for Enabled SubSystem: '<S588>/Check msg transmission CAN1' */
            ...
            /* End of Disable for SubSystem: '<S588>/Check msg transmission CAN1' */

            /* Disable for Enabled SubSystem: '<S588>/Check msg transmission CAN2' */
            ...
            /* End of Disable for SubSystem: '<S588>/Check msg transmission CAN2' */

            /* Disable for Outport: '<S588>/Send CAN1' */
            localB->CheckmsgtransmissionCAN1_a.Equal7 = false;

            /* Disable for Outport: '<S588>/Send CAN2' */
            localB->CheckmsgtransmissionCAN2_c.Equal7 = false;
            localDW->Transmissionsubtasks_MODE = false;
          }

          /* End of Disable for SubSystem: '<S580>/Transmission subtasks' */

          /* Disable for Outport: '<S580>/Send CAN1' */
          localB->CheckmsgtransmissionCAN1_a.Equal7 = false;

          /* Disable for Outport: '<S580>/Receive CAN1' */
          localB->Receptionsubstasks_n.AND = false;

          /* Disable for Outport: '<S580>/Send CAN2' */
          localB->CheckmsgtransmissionCAN2_c.Equal7 = false;

          /* Disable for Outport: '<S580>/Receive CAN2' */
          localB->Receptionsubstasks_n.AND1 = false;
          localDW->COMMTaskSet_Values_MODE = false;
        }

        /* End of Disable for SubSystem: '<S519>/COMM Task - Set_Values' */

        /* Disable for Enabled SubSystem: '<S519>/COMM Task - Sync bc 1' */
        ...
        /* End of Disable for SubSystem: '<S519>/COMM Task - Sync bc 1' */

        /* Disable for Outport: '<S519>/Send_Message_CAN1' */
        localB->OR1 = false;

        /* Disable for Outport: '<S519>/Send_Message_CAN2' */
        localB->OR4 = false;

        /* Disable for Outport: '<S519>/Receive_Message_CAN1' */
        localB->OR3 = false;

        /* Disable for Outport: '<S519>/Receive_Message_CAN2' */
        localB->OR2 = false;
               ...
               *rtd_Tx_msg_count_CAN1, real_T *rtd_Tx_msg_count_CAN2)
{
  ...
  boolean_T rtb_NOT_d;
  boolean_T rtb_DataStoreRead1_mp;
  boolean_T rtb_DataStoreRead2_i1;
  msg_buffer_type rtb_DataStoreRead_ik;
  msg_buffer_type rtb_DataStoreRead3_g;
  boolean_T rtb_AND1_fa;
  boolean_T rtb_Equal2_d;
  boolean_T rtb_AND1_nj;
  boolean_T rtb_DataStoreRead1_d3;
   ...
   *  Constant: '<S518>/Constant25'
   *  Constant: '<S518>/Constant31'
   *  Constant: '<S518>/Constant4'
   *  Constant: '<S519>/Constant'
   *  Constant: '<S519>/Constant12'
   *  Constant: '<S519>/Constant16'
   ...
   *  DataStoreRead: '<S441>/Data Store Read6'
   ...
   *  DataStoreWrite: '<S485>/Data Store Write2'
   *  DataStoreWrite: '<S547>/Data Store Write2'
   *  DataStoreWrite: '<S636>/Data Store Write2'
   *  Logic: '<S162>/AND1'
   *  Logic: '<S162>/AND10'
   *  Logic: '<S162>/AND11'
   *  Logic: '<S162>/AND12'
   ...
   *  RelationalOperator: '<S393>/Equal16'
   *  RelationalOperator: '<S518>/GreaterThan2'
   *  RelationalOperator: '<S518>/GreaterThan3'
   *  RelationalOperator: '<S518>/GreaterThan30'
   *  RelationalOperator: '<S518>/GreaterThan31'
   *  RelationalOperator: '<S518>/GreaterThan32'
   *  RelationalOperator: '<S518>/GreaterThan33'
   *  RelationalOperator: '<S518>/GreaterThan4'
   *  RelationalOperator: '<S518>/GreaterThan5'
   *  RelationalOperator: '<S519>/GreaterThan10'
   *  RelationalOperator: '<S519>/GreaterThan11'
   *  RelationalOperator: '<S519>/GreaterThan2'
   *  RelationalOperator: '<S519>/GreaterThan3'
   *  RelationalOperator: '<S519>/GreaterThan34'
   *  RelationalOperator: '<S519>/GreaterThan35'
   *  RelationalOperator: '<S519>/GreaterThan4'
   *  RelationalOperator: '<S519>/GreaterThan5'
   *  RelationalOperator: '<S519>/GreaterThan6'
   *  RelationalOperator: '<S519>/GreaterThan7'
   *  RelationalOperator: '<S519>/GreaterThan8'
   *  RelationalOperator: '<S519>/GreaterThan9'
   *  RelationalOperator: '<S522>/Equal1'
   *  RelationalOperator: '<S522>/Equal2'
   *  RelationalOperator: '<S523>/Equal2'
   *  RelationalOperator: '<S525>/Equal3'
   *  RelationalOperator: '<S582>/Equal1'
   *  RelationalOperator: '<S582>/Equal2'
   *  RelationalOperator: '<S586>/Equal3'
   *  RelationalOperator: '<S588>/Equal16'
   */
  if (!localDW->Initialization_flag) {
    if (!localDW->MatrixCycleManager_MODE) {
    ...
    if (rtb_OR1_l) {
      ...
      if (rtb_Equal_kj) {
        ...
        if ((*rtd_Local_Ticks >= 44.0) && (*rtd_Local_Ticks < localC->Sum2_n) &&
          ...
          if ((*rtd_Local_Ticks == 46.0) && (localDW->Role_ID == 2.0) &&
             ...
             *  DataStoreWrite: '<S293>/Data Store Write'
             */
            rtb_NOT_ev = !localDW->Desync_Positive;

            /* Outputs for Enabled SubSystem: '<S293>/Desync_Negative' */
            Desync_Negative(rtb_NOT_ev, 44.0, &localDW->Desync_Ticks,
                            rtd_Local_Ticks);
      ...
      if (localDW->basic_cycle_count == 1.0) {
        ...
        {
          /* Outputs for Enabled SubSystem: '<S388>/Check Timeouts' incorporates:
           *  EnablePort: '<S437>/Enable'
           */
          if (*rtd_Local_Ticks == 200.0) {
            /* Logic: '<S437>/AND9' incorporates:
             *  DataStoreRead: '<S437>/Data Store Read25'
             *  DataStoreWrite: '<S437>/Data Store Write8'
             *  Logic: '<S437>/NOT4'
             *  RelationalOperator: '<S437>/Equal9'
             */
            localDW->Toggle_Pin_A1 = ((!localDW->BC1_Sync_processed) &&
              (*rtd_Master_ID != *rtd_Board_ID));

            /* Switch: '<S437>/Switch7' incorporates:
             *  Constant: '<S437>/Constant16'
             *  DataStoreRead: '<S437>/Data Store Read23'
             *  DataStoreWrite: '<S437>/Data Store Write8'
             *  DataStoreWrite: '<S437>/Data Store Write9'
             *  Sum: '<S437>/Plus6'
             */
            ...
            /* End of Switch: '<S437>/Switch7' */
          }

          /* End of Outputs for SubSystem: '<S388>/Check Timeouts' */
          ...
          /* Outputs for Enabled SubSystem: '<S388>/Reset Variables' */
        ...
        if ((*rtd_Local_Ticks >= 88.0) && (*rtd_Local_Ticks < localC->Sum5_h)) {
          ...
          /* DataStoreRead: '<S389>/Data Store Read2' */
          rtb_DataStoreRead2_na = *rtd_New_Msg_Ready_CAN2;

          /* DataStoreRead: '<S389>/Data Store Read' */
          rtb_DataStoreRead_i25 = *rtd_Msg_Rx_CAN1;

          /* DataStoreRead: '<S389>/Data Store Read3' */
          rtb_DataStoreRead3_km = *rtd_Msg_Rx_CAN2;

          /* RelationalOperator: '<S389>/Equal' */
          rtb_AND_ck = (*rtd_Local_Ticks == 88.0);

          /* RelationalOperator: '<S389>/Equal13' incorporates:
           *  Constant: '<S389>/Constant57'
           */
          rtb_AND1_e = (*rtd_Board_ID != 8.0);

          /* Outputs for Enabled SubSystem: '<S389>/Process_Messages' incorporates:
          ...
          if (rtb_AND_ck && rtb_AND1_e) {
            ...
            /* Outputs for Enabled SubSystem: '<S439>/Demux message CAN1 and check coherence' */
            DemuxmessageCAN1andcheckcoher_e(rtb_DataStoreRead1_b5,
              &rtb_DataStoreRead_i25, 8.0,
              &localB->DemuxmessageCAN1andcheckcoher_f,
              &localDW->DemuxmessageCAN1andcheckcoher_f,
              &localDW->msg_count_DEBUG_i);

            /* End of Outputs for SubSystem: '<S439>/Demux message CAN1 and check coherence' */

            /* Outputs for Enabled SubSystem: '<S439>/Demux message CAN1 and check coherence1' */
            DemuxmessageCAN1andcheckcoher_m(rtb_DataStoreRead2_na,
              &rtb_DataStoreRead3_km, 8.0,
              &localB->DemuxmessageCAN1andcheckcohe_g5,
              &localDW->DemuxmessageCAN1andcheckcohe_g5,
              &localDW->msg_count_DEBUG_i);

            /* End of Outputs for SubSystem: '<S439>/Demux message CAN1 and check coherence1' */
            ...
            /* Logic: '<S439>/OR' incorporates:
             *  DataStoreWrite: '<S439>/Data Store Write1'
             */
          ...
          /* End of Outputs for SubSystem: '<S389>/Process_Messages' */
          ...
          /* Outputs for Enabled SubSystem: '<S389>/Reset Tx msg counter' */
          ResetTxmsgcounter(rtb_AND1_dx, rtd_Tx_msg_count_CAN1,
                            rtd_Tx_msg_count_CAN2);

          /* End of Outputs for SubSystem: '<S389>/Reset Tx msg counter' */

          /* Outputs for Enabled SubSystem: '<S389>/Update Msg buffer' incorporates:
           *  EnablePort: '<S441>/Enable'
           */
          if ((*rtd_Local_Ticks == 90.0) && rtb_AND1_e) {
            /* DataStoreRead: '<S441>/Data Store Read5' */
            new_set_rx_s = localDW->new_msg_Rx_g;

            /* Outputs for Enabled SubSystem: '<S441>/Set Values Update' incorporates:
             *  EnablePort: '<S468>/Enable'
             */
            if (new_set_rx_s) {
              /* Outputs for Atomic SubSystem: '<S471>/Bit Shift' */
              BitShift(localDW->Msg_Rx_f.Buffer_3, &localB->BitShift_a);

              /* End of Outputs for SubSystem: '<S471>/Bit Shift' */
              ...
              /* Sum: '<S471>/Minus' incorporates:
               *  DataStoreRead: '<S441>/Data Store Read6'
               *  DataTypeConversion: '<S471>/Cast1'
               */
              rtb_Switch1_f = localDW->Msg_Rx_f.Buffer_3 - localB->BitShift1_j.y;

              /* Product: '<S471>/Divide' */
              rtb_Plus1_b = rtb_Switch1_f / localC->Power1_a;

              /* Rounding: '<S471>/Fix1' */
              if (rtb_Plus1_b < 0.0) {
                rtb_Plus_j = ceil(rtb_Plus1_b);
              } else {
                rtb_Plus_j = floor(rtb_Plus1_b);
              }

              /* End of Rounding: '<S471>/Fix1' */
              ...
              if (localB->BitShift_a.y > ((uint8_T)0U)) {
                rxDeltaA = ((rtb_Switch1_f - rtb_Plus_j * localC->Power1_a) *
                            localC->Power_jw + rtb_Plus_j) * (-1.0);
              } else {
                rxDeltaA = (rtb_Switch1_f - rtb_Plus_j * localC->Power1_a) *
                  localC->Power_jw + rtb_Plus_j;
              }
              ...
              /* Sum: '<S470>/Minus' incorporates:
               *  DataStoreRead: '<S441>/Data Store Read6'
               *  DataTypeConversion: '<S470>/Cast1'
               */
              rtb_Plus_j = localDW->Msg_Rx_f.Buffer_2 - localB->BitShift1_k.y;

              /* Product: '<S470>/Divide' */
              rtb_Plus1_b = rtb_Plus_j / localC->Power1_h;

              /* Rounding: '<S470>/Fix1' */
              if (rtb_Plus1_b < 0.0) {
                rtb_Switch1_f = ceil(rtb_Plus1_b);
              } else {
                rtb_Switch1_f = floor(rtb_Plus1_b);
              }

              /* End of Rounding: '<S470>/Fix1' */
               ...
               *  Sum: '<S470>/Minus2'
               */
              if (localB->BitShift_g.y > ((uint8_T)0U)) {
                rxDeltaF = ((rtb_Plus_j - rtb_Switch1_f * localC->Power1_h) *
                            localC->Power_cs + rtb_Switch1_f) * (-1.0);
              } else {
                rxDeltaF = (rtb_Plus_j - rtb_Switch1_f * localC->Power1_h) *
                  localC->Power_cs + rtb_Switch1_f;
              }

              /* End of Switch: '<S470>/Switch' */

              /* Outputs for Atomic SubSystem: '<S472>/Bit Shift' */
              BitShift(localDW->Msg_Rx_f.Buffer_4, &localB->BitShift_o);

              /* End of Outputs for SubSystem: '<S472>/Bit Shift' */

              /* Outputs for Atomic SubSystem: '<S472>/Bit Shift1' */
              BitShift1(localB->BitShift_o.y, &localB->BitShift1_kf);

              /* End of Outputs for SubSystem: '<S472>/Bit Shift1' */

              /* Sum: '<S472>/Minus' incorporates:
               *  DataStoreRead: '<S441>/Data Store Read6'
               *  DataTypeConversion: '<S472>/Cast1'
               */
              rtb_Plus_j = localDW->Msg_Rx_f.Buffer_4 - localB->BitShift1_kf.y;

              /* Product: '<S472>/Divide' */
              rtb_Plus1_b = rtb_Plus_j / localC->Power1_b;
               ...
               *  Sum: '<S472>/Minus2'
               */
              if (localB->BitShift_o.y > ((uint8_T)0U)) {
                rxSpeedV = ((rtb_Plus_j - rtb_Switch1_f * localC->Power1_b) *
                            localC->Power_j3 + rtb_Switch1_f) * (-1.0);
              } else {
                rxSpeedV = (rtb_Plus_j - rtb_Switch1_f * localC->Power1_b) *
                  localC->Power_j3 + rtb_Switch1_f;
              }

              /* End of Switch: '<S472>/Switch' */
            }

            /* End of Outputs for SubSystem: '<S441>/Set Values Update' */
          }

          /* End of Outputs for SubSystem: '<S389>/Update Msg buffer' */
        } else {
          if (localDW->COMPTaskRx_Set_Values_Check_MOD) {
            /* Disable for Enabled SubSystem: '<S389>/Process_Messages' */
            if (localDW->Process_Messages_MODE_g) {
        ...
        if ((*rtd_Local_Ticks >= 40.0) && (*rtd_Local_Ticks < localC->Sum1_h) &&
          ...
          /* DataStoreRead: '<S390>/Data Store Read15' */
          rtb_DataStoreRead15 = *rtd_Master_ID;

          /* RelationalOperator: '<S390>/Equal' */
          rtb_AND_ck = (*rtd_Local_Ticks == 40.0);

          /* RelationalOperator: '<S390>/Equal5' incorporates:
          ...
          if (rtb_AND_ck && rtb_AND1_e) {
            ...
            /* Outputs for Enabled SubSystem: '<S485>/Demux message CAN1 and check coherence' */
            DemuxmessageCAN1andcheckcoheren(rtb_DataStoreRead1_b,
              &rtb_DataStoreRead_dg, 1.0, rtb_DataStoreRead15,
              &localB->DemuxmessageCAN1andcheckcoher_a,
              &localDW->DemuxmessageCAN1andcheckcoher_a,
              &localDW->msg_count_DEBUG_i);

            /* End of Outputs for SubSystem: '<S485>/Demux message CAN1 and check coherence' */

            /* Outputs for Enabled SubSystem: '<S485>/Demux message CAN1 and check coherence1' */
            DemuxmessageCAN1andcheckcoher_p(rtb_DataStoreRead2_pe,
              &rtb_DataStoreRead3_ll, 1.0, rtb_DataStoreRead15,
              &localB->DemuxmessageCAN1andcheckcoher_i,
              &localDW->DemuxmessageCAN1andcheckcoher_i,
              &localDW->msg_count_DEBUG_i);

            /* End of Outputs for SubSystem: '<S485>/Demux message CAN1 and check coherence1' */

            /* Switch: '<S485>/Switch' incorporates:
             *  Constant: '<S390>/Constant'
             *  DataStoreWrite: '<S485>/Data Store Write'
             */
            ...
            /* Outputs for Enabled SubSystem: '<S485>/Desync calculation' incorporates:
            ...
            if (localDW->new_msg_Rx_g) {
               ...
               *  Constant: '<S489>/delay_estimation_1'
               *  Constant: '<S489>/delay_estimation_2'
            ...
            /* End of Outputs for SubSystem: '<S485>/Desync calculation' */

            /* DataStoreWrite: '<S485>/Data Store Write3' incorporates:
        ...
        if ((*rtd_Local_Ticks >= 44.0) && (*rtd_Local_Ticks < localC->Sum2_a) &&
            (!localDW->BC1_Sync_processed)) {
          /* Outputs for Enabled SubSystem: '<S391>/LA - Ensemble precision' incorporates:
          ...
          /* End of Outputs for SubSystem: '<S391>/LA - Ensemble precision' */
           ...
           *  Logic: '<S391>/AND1'
           *  RelationalOperator: '<S391>/Equal1'
          ...
          /* Outputs for Enabled SubSystem: '<S391>/Local Time Update' */
        ...
        if ((rtb_DataStoreRead8_c >= 48.0) && (rtb_DataStoreRead8_c <
          ...
          if (rtb_AND_ck) {
             ...
             *  RelationalOperator: '<S393>/GreaterThan2'
             */
            rtb_AND_oxj = (rtb_AND_ck && (*rtd_Tx_msg_count_CAN1 <= 7.0));

            /* Logic: '<S393>/AND1' incorporates:
             *  Constant: '<S393>/Constant7'
             *  RelationalOperator: '<S393>/GreaterThan3'
             */
            rtb_AND1_ke = (rtb_AND_ck && (*rtd_Tx_msg_count_CAN2 <= 7.0));

            /* Outputs for Enabled SubSystem: '<S393>/Msg_Value_Data_Encoded' incorporates:
            ...
            if (rtb_DataStoreRead_om == 48.0) {
               ...
               *  RelationalOperator: '<S410>/LessThanOrEqual1'
               *  RelationalOperator: '<S410>/LessThanOrEqual2'
               *  Switch: '<S410>/Switch1'
               */
              if (1.0 < delta_a_set) {
                /* Switch: '<S410>/Switch' */
              ...
              /* RelationalOperator: '<S410>/GreaterThan' incorporates:
              ...
              /* End of Rounding: '<S410>/Fix1' */

              /* Sum: '<S410>/Plus' incorporates:
               *  DataTypeConversion: '<S410>/Cast1'
               *  DataTypeConversion: '<S410>/Cast2'
               */
               ...
               *  RelationalOperator: '<S411>/LessThanOrEqual1'
               *  RelationalOperator: '<S411>/LessThanOrEqual2'
               *  Switch: '<S411>/Switch1'
               */
              if (10.0 < v_set) {
                /* Switch: '<S411>/Switch' */
              ...
              /* RelationalOperator: '<S411>/GreaterThan' incorporates:
              ...
              /* DataTypeConversion: '<S411>/Cast' */
              rtb_Cast_db = rtb_AND_ck;

              /* Outputs for Atomic SubSystem: '<S411>/Bit Shift' */
              BitShift1(rtb_Cast_db, &localB->BitShift_k);

              /* End of Outputs for SubSystem: '<S411>/Bit Shift' */
              ...
              /* End of Rounding: '<S411>/Fix1' */

              /* Sum: '<S411>/Plus' incorporates:
               *  DataTypeConversion: '<S411>/Cast1'
               *  DataTypeConversion: '<S411>/Cast2'
               */
            ...
            /* End of Outputs for SubSystem: '<S393>/Msg_Value_Data_Encoded' */

            /* Outputs for Enabled SubSystem: '<S393>/Check msg transmission CAN1' */
            ...
            /* Outputs for Enabled SubSystem: '<S393>/Check msg transmission CAN2' */
            CheckmsgtransmissionCAN2(rtb_AND1_ke, rtb_DataStoreRead_om, 48.0,
              localB->Plus_jp, localB->Plus_j, localB->Plus_bx,
    ...
    if (*rtd_Board_ID == 8.0) {
      ...
      if (rtb_Equal_kj) {
        ...
        /* DataStoreRead: '<S518>/Data Store Read8' */
        rtb_DataStoreRead8_c = *rtd_Local_Ticks;

        /* Outputs for Enabled SubSystem: '<S518>/COMP Task - Reset Board' incorporates:
         *  EnablePort: '<S522>/Enable'
         */
        if ((*rtd_Local_Ticks >= 48.0) && (*rtd_Local_Ticks < localC->Sum17)) {
          /* Outputs for Enabled SubSystem: '<S522>/Check Timeouts' incorporates:
           *  EnablePort: '<S544>/Enable'
           */
          if (*rtd_Local_Ticks == 48.0) {
            /* Logic: '<S544>/NOT4' incorporates:
             *  DataStoreRead: '<S544>/Data Store Read25'
             *  DataStoreWrite: '<S544>/Data Store Write8'
             */
            localDW->Toggle_Pin_A1 = !localDW->BC0_Sync_processed;

            /* Switch: '<S544>/Switch7' incorporates:
             *  Constant: '<S544>/Constant16'
             *  DataStoreRead: '<S544>/Data Store Read23'
             *  DataStoreWrite: '<S544>/Data Store Write8'
             *  DataStoreWrite: '<S544>/Data Store Write9'
             *  Sum: '<S544>/Plus6'
             */
            if (localDW->Toggle_Pin_A1) {
            ...
            /* End of Switch: '<S544>/Switch7' */
          }

          /* End of Outputs for SubSystem: '<S522>/Check Timeouts' */

          /* DataStoreRead: '<S522>/Data Store Read' incorporates:
           *  RelationalOperator: '<S522>/Equal2'
           */
          reset_ing_s = localDW->Reset_Board_j;

          /* Outputs for Enabled SubSystem: '<S522>/RESET Board - Return to initialization' incorporates:
           *  EnablePort: '<S545>/Enable'
           */
          if ((*rtd_Local_Ticks == 50.0) && reset_ing_s) {
            /* DataStoreWrite: '<S545>/Data Store Write' */
            localDW->Reset_Board_j = localC->Cast_j;

            /* DataStoreWrite: '<S545>/Data Store Write1' */
            *rtd_New_Msg_Ready_CAN1 = localC->Cast_j;

            /* DataStoreWrite: '<S545>/Data Store Write10' */
            *rtd_New_Msg_Ready_CAN2 = localC->Cast_j;

            /* DataStoreWrite: '<S545>/Data Store Write11' */
            localDW->Desync_Positive = localC->Cast_j;

            /* DataStoreWrite: '<S545>/Data Store Write2' */
            localDW->Initialization_flag = localC->NOT_l;

            /* DataStoreWrite: '<S545>/Data Store Write4' incorporates:
             *  Constant: '<S545>/Constant'
             */
            localDW->Role_ID = 0.0;

            /* DataStoreWrite: '<S545>/Data Store Write5' incorporates:
             *  Constant: '<S545>/Constant'
             */
            *rtd_Master_ID = 0.0;

            /* DataStoreWrite: '<S545>/Data Store Write6' */
            *rtd_Rx_State_CAN1 = localC->Cast6_k;

            /* DataStoreWrite: '<S545>/Data Store Write9' */
            *rtd_Rx_State_CAN2 = localC->Cast6_k;

            /* DataStoreWrite: '<S545>/Data Store Write3' incorporates:
             *  Constant: '<S545>/Constant1'
             */
            *rtd_RxID_CAN1 = 1U;

            /* DataStoreWrite: '<S545>/Data Store Write8' incorporates:
             *  Constant: '<S545>/Constant1'
             */
            *rtd_RxID_CAN2 = 1U;

            /* DataStoreWrite: '<S545>/Data Store Write7' incorporates:
             *  Constant: '<S545>/Constant3'
             */
            *rtd_Toggle_Pin_A0 = true;
          }

          /* End of Outputs for SubSystem: '<S522>/RESET Board - Return to initialization' */
        }

        /* End of Outputs for SubSystem: '<S518>/COMP Task - Reset Board' */

        /* Outputs for Enabled SubSystem: '<S518>/COMP Task - Reset Variables BC0' incorporates:
         *  EnablePort: '<S523>/Enable'
         */
        /* Outputs for Enabled SubSystem: '<S523>/Reset variables' incorporates:
         *  EnablePort: '<S546>/Enable'
         */
        if ((*rtd_Local_Ticks >= 204.0) && (*rtd_Local_Ticks < localC->Sum16) &&
            (*rtd_Local_Ticks == 204.0)) {
          /* DataStoreWrite: '<S546>/Data Store Write' incorporates:
           *  Constant: '<S546>/Constant'
           */
          localDW->Desync_Positive = false;

          /* DataStoreWrite: '<S546>/Data Store Write1' incorporates:
           *  Constant: '<S546>/Constant'
           */
          localDW->BC0_Sync_processed = false;

          /* DataStoreWrite: '<S546>/Data Store Write5' incorporates:
           *  Constant: '<S546>/Constant3'
           */
          *rtd_Toggle_Pin_A0 = true;
        }

        /* End of Outputs for SubSystem: '<S523>/Reset variables' */
        /* End of Outputs for SubSystem: '<S518>/COMP Task - Reset Variables BC0' */

        /* Logic: '<S518>/NOT1' incorporates:
         *  Constant: '<S518>/Constant25'
         *  Constant: '<S518>/Constant31'
         *  Constant: '<S518>/Constant4'
        ...
        /* Outputs for Enabled SubSystem: '<S518>/COMP Task - Sync bc0 check' incorporates:
        ...
        if ((*rtd_Local_Ticks >= 40.0) && (*rtd_Local_Ticks < localC->Sum1_m) &&
          ...
          rtb_DataStoreRead1_mp = *rtd_New_Msg_Ready_CAN1;

          /* DataStoreRead: '<S524>/Data Store Read2' */
          rtb_DataStoreRead2_i1 = *rtd_New_Msg_Ready_CAN2;

          /* DataStoreRead: '<S524>/Data Store Read' */
          rtb_DataStoreRead_ik = *rtd_Msg_Rx_CAN1;

          /* DataStoreRead: '<S524>/Data Store Read3' */
          rtb_DataStoreRead3_g = *rtd_Msg_Rx_CAN2;

          /* RelationalOperator: '<S524>/Equal' */
          rtb_AND_ck = (*rtd_Local_Ticks == 40.0);

          /* RelationalOperator: '<S524>/Equal5' incorporates:
           *  Constant: '<S524>/Constant26'
           *  DataStoreRead: '<S524>/Data Store Read6'
           */
          rtb_AND1_e = (localDW->Role_ID != 1.0);

          /* Outputs for Enabled SubSystem: '<S524>/Process_Messages' incorporates:
          ...
          if (rtb_AND_ck && rtb_AND1_e) {
            ...
            /* Outputs for Enabled SubSystem: '<S547>/Demux message CAN1 and check coherence' */
            DemuxmessageCAN1andcheckcoher_d(rtb_DataStoreRead1_mp,
              &rtb_DataStoreRead_ik, 0.0,
              &localB->DemuxmessageCAN1andcheckcohe_d0,
              &localDW->DemuxmessageCAN1andcheckcohe_d0,
            ...
            /* Outputs for Enabled SubSystem: '<S547>/Demux message CAN1 and check coherence1' */
            DemuxmessageCAN1andcheckcoher_h(rtb_DataStoreRead2_i1,
              &rtb_DataStoreRead3_g, 0.0,
              &localB->DemuxmessageCAN1andcheckcohe_h5,
              &localDW->DemuxmessageCAN1andcheckcohe_h5,
              &localDW->msg_count_DEBUG);
            ...
            /* Outputs for Enabled SubSystem: '<S547>/Desync calculation' incorporates:
            ...
            if (localDW->new_msg_Rx_i) {
               ...
               *  Constant: '<S551>/delay_estimation_1'
               *  Constant: '<S551>/delay_estimation_2'
               *  Product: '<S551>/Multiply'
               *  Product: '<S551>/Multiply1'
               *  Sum: '<S551>/Minus'
               *  Sum: '<S551>/Minus1'
               *  Sum: '<S551>/Sum'
               *  Sum: '<S551>/Sum1'
              ...
              /* DataStoreWrite: '<S551>/Data Store Write1' */
              localDW->Desync_Ticks = Desync_Sync_bc0_ing_s;
            }

            /* End of Outputs for SubSystem: '<S547>/Desync calculation' */

            /* DataStoreWrite: '<S547>/Data Store Write3' incorporates:
          ...
          /* End of Outputs for SubSystem: '<S524>/Process_Messages' */

          /* Logic: '<S524>/AND1' incorporates:
           *  Constant: '<S524>/Constant'
           *  DataStoreWrite: '<S547>/Data Store Write2'
           *  Logic: '<S524>/AND'
           *  Logic: '<S524>/NOT'
           */
          rtb_AND1_fa = (rtb_AND_ck && (!rtb_AND1_e));

          /* Outputs for Enabled SubSystem: '<S524>/Reset Tx msg counter' */
          ResetTxmsgcounter(rtb_AND1_fa, rtd_Tx_msg_count_CAN1,
                            rtd_Tx_msg_count_CAN2);

          /* End of Outputs for SubSystem: '<S524>/Reset Tx msg counter' */
        } else {
          if (localDW->COMPTaskSyncbc0check_MODE) {
            /* Disable for Enabled SubSystem: '<S524>/Process_Messages' */
            if (localDW->Process_Messages_MODE_n) {
        ...
        /* End of Outputs for SubSystem: '<S518>/COMP Task - Sync bc0 check' */

        /* Outputs for Enabled SubSystem: '<S518>/COMP Task - Update LT' incorporates:
         *  EnablePort: '<S525>/Enable'
         */
        if ((*rtd_Local_Ticks >= 44.0) && (*rtd_Local_Ticks < localC->Sum2_o) &&
            rtb_AND2_n) {
          /* RelationalOperator: '<S525>/Equal1' incorporates:
           *  Constant: '<S518>/Constant3'
           */
          rtb_AND_ck = (*rtd_Local_Ticks == 46.0);

          /* Outputs for Enabled SubSystem: '<S525>/LA - Ensemble precision' incorporates:
           *  EnablePort: '<S576>/Enable'
           */
          if ((*rtd_Local_Ticks == 44.0) && (1.0 != 0.0)) {
            /* DataStoreWrite: '<S576>/Data Store Write1' incorporates:
             *  Constant: '<S576>/Constant2'
             */
            localDW->Toggle_Pin_D10 = true;
          }

          /* End of Outputs for SubSystem: '<S525>/LA - Ensemble precision' */

          /* Outputs for Enabled SubSystem: '<S525>/Local Time Update' incorporates:
           *  EnablePort: '<S577>/Enable'
           */
          if (rtb_AND_ck && localDW->new_msg_Rx_i) {
            /* RelationalOperator: '<S577>/GreaterThan' incorporates:
             *  Constant: '<S577>/Constant4'
             *  DataStoreRead: '<S577>/Data Store Read1'
             *  DataStoreWrite: '<S577>/Data Store Write'
             */
            localDW->Desync_Positive = (localDW->Desync_Ticks > 0.0);

            /* Logic: '<S577>/NOT' incorporates:
             *  DataStoreWrite: '<S577>/Data Store Write'
             */
            rtb_NOT_nq = !localDW->Desync_Positive;

            /* Outputs for Enabled SubSystem: '<S577>/Desync_Negative' */
            Desync_Negative(rtb_NOT_nq, 44.0, &localDW->Desync_Ticks,
                            rtd_Local_Ticks);

            /* End of Outputs for SubSystem: '<S577>/Desync_Negative' */

            /* DataStoreWrite: '<S577>/Data Store Write13' incorporates:
             *  Constant: '<S577>/Constant3'
             */
            localDW->BC0_Sync_processed = true;

            /* DataStoreWrite: '<S577>/Data Store Write3' incorporates:
             *  Constant: '<S577>/Constant1'
             */
            *rtd_Toggle_Pin_A0 = true;

            /* DataStoreWrite: '<S577>/Data Store Write1' incorporates:
             *  Constant: '<S577>/Constant2'
             */
            localDW->Toggle_Pin_D10 = true;
          }

          /* End of Outputs for SubSystem: '<S525>/Local Time Update' */

          /* Outputs for Enabled SubSystem: '<S525>/Set Reset Board' incorporates:
           *  EnablePort: '<S578>/Enable'
           */
          if (rtb_AND_ck && (!localDW->new_msg_Rx_i)) {
            /* DataStoreWrite: '<S578>/Data Store Write' incorporates:
             *  Constant: '<S578>/Constant'
             */
            localDW->Reset_Board_j = true;
          }

          /* End of Outputs for SubSystem: '<S525>/Set Reset Board' */
        }

        /* End of Outputs for SubSystem: '<S518>/COMP Task - Update LT' */

        /* Logic: '<S518>/AND17' incorporates:
         *  Constant: '<S518>/Constant'
         *  Constant: '<S518>/Constant17'
         *  Constant: '<S518>/Constant2'
         *  Constant: '<S524>/Constant'
         *  Constant: '<S525>/Constant1'
         *  DataStoreRead: '<S518>/Data Store Read11'
         *  DataStoreRead: '<S525>/Data Store Read'
         *  DataStoreWrite: '<S547>/Data Store Write2'
         *  Logic: '<S518>/AND'
         *  Logic: '<S518>/AND1'
         ...
         *  Logic: '<S525>/AND2'
         *  Logic: '<S525>/NOT'
         *  RelationalOperator: '<S518>/GreaterThan'
         *  RelationalOperator: '<S518>/GreaterThan1'
         *  RelationalOperator: '<S518>/GreaterThan2'
         *  RelationalOperator: '<S518>/GreaterThan3'
         *  RelationalOperator: '<S518>/GreaterThan4'
         *  RelationalOperator: '<S518>/GreaterThan5'
        ...
        /* Outputs for Enabled SubSystem: '<S518>/COMM Task - Sync bc 0' */
        ...
        /* End of Outputs for SubSystem: '<S518>/COMM Task - Sync bc 0' */
      } else {
        if (localDW->inputgeneratorbasiccycle0_MODE) {
          /* Disable for Enabled SubSystem: '<S518>/COMP Task - Sync bc0 check' */
          if (localDW->COMPTaskSyncbc0check_MODE) {
      ...
      if (localDW->basic_cycle_count == 1.0) {
        ...
        /* DataStoreRead: '<S519>/Data Store Read1' */
        rtb_DataStoreRead8_c = *rtd_Local_Ticks;

        /* Outputs for Enabled SubSystem: '<S519>/COMP Task - Reset Board' incorporates:
         *  EnablePort: '<S582>/Enable'
         */
        if ((*rtd_Local_Ticks >= 132.0) && (*rtd_Local_Ticks < localC->Sum5)) {
          /* Outputs for Enabled SubSystem: '<S582>/Check Timeouts' incorporates:
           *  EnablePort: '<S632>/Enable'
           */
          if (*rtd_Local_Ticks == 132.0) {
            /* Logic: '<S632>/NOT4' incorporates:
             *  DataStoreRead: '<S632>/Data Store Read25'
             *  DataStoreWrite: '<S632>/Data Store Write8'
             */
            localDW->Toggle_Pin_A1 = !localDW->BC1_Sync_processed;

            /* Switch: '<S632>/Switch7' incorporates:
             *  Constant: '<S632>/Constant16'
             *  DataStoreRead: '<S632>/Data Store Read23'
             *  DataStoreWrite: '<S632>/Data Store Write8'
             *  DataStoreWrite: '<S632>/Data Store Write9'
             *  Sum: '<S632>/Plus6'
             */
            if (localDW->Toggle_Pin_A1) {
            ...
            /* End of Switch: '<S632>/Switch7' */
          }

          /* End of Outputs for SubSystem: '<S582>/Check Timeouts' */

          /* Outputs for Enabled SubSystem: '<S582>/RESET Board - Return to initialization' incorporates:
           *  EnablePort: '<S633>/Enable'
           */
          if ((*rtd_Local_Ticks == 134.0) && localDW->Reset_Board) {
            /* DataStoreWrite: '<S633>/Data Store Write' */
            localDW->Reset_Board = localC->Cast_o;

            /* DataStoreWrite: '<S633>/Data Store Write1' */
            *rtd_New_Msg_Ready_CAN1 = localC->Cast_o;

            /* DataStoreWrite: '<S633>/Data Store Write10' */
            *rtd_New_Msg_Ready_CAN2 = localC->Cast_o;

            /* DataStoreWrite: '<S633>/Data Store Write11' */
            localDW->Desync_Positive = localC->Cast_o;

            /* DataStoreWrite: '<S633>/Data Store Write12' */
            localDW->BC1_Sync_processed = localC->Cast_o;

            /* DataStoreWrite: '<S633>/Data Store Write2' */
            localDW->Initialization_flag = localC->NOT;

            /* DataStoreWrite: '<S633>/Data Store Write4' incorporates:
             *  Constant: '<S633>/Constant'
             */
            localDW->Role_ID = 0.0;

            /* DataStoreWrite: '<S633>/Data Store Write5' incorporates:
             *  Constant: '<S633>/Constant'
             */
            *rtd_Master_ID = 0.0;

            /* DataStoreWrite: '<S633>/Data Store Write6' */
            *rtd_Rx_State_CAN1 = localC->Cast6;

            /* DataStoreWrite: '<S633>/Data Store Write9' */
            *rtd_Rx_State_CAN2 = localC->Cast6;

            /* DataStoreWrite: '<S633>/Data Store Write3' incorporates:
             *  Constant: '<S633>/Constant1'
             */
            *rtd_RxID_CAN1 = 1U;

            /* DataStoreWrite: '<S633>/Data Store Write8' incorporates:
             *  Constant: '<S633>/Constant1'
             */
            *rtd_RxID_CAN2 = 1U;

            /* DataStoreWrite: '<S633>/Data Store Write7' incorporates:
             *  Constant: '<S633>/Constant3'
             */
            *rtd_Toggle_Pin_A0 = true;
          }

          /* End of Outputs for SubSystem: '<S582>/RESET Board - Return to initialization' */
        }

        /* End of Outputs for SubSystem: '<S519>/COMP Task - Reset Board' */

        /* Outputs for Enabled SubSystem: '<S519>/COMP Task - Reset Variables BC1' incorporates:
         *  EnablePort: '<S583>/Enable'
         */
        if ((*rtd_Local_Ticks >= 200.0) && (*rtd_Local_Ticks < localC->Sum18)) {
          /* RelationalOperator: '<S583>/Equal2' */
          rtb_Equal2_d = (*rtd_Local_Ticks == 200.0);

          /* Outputs for Enabled SubSystem: '<S583>/Reset Variables' */
          ResetVariables(rtb_Equal2_d, &localDW->BC1_Sync_processed,
                         &localDW->Desync_Positive, rtd_Toggle_Pin_A0);

          /* End of Outputs for SubSystem: '<S583>/Reset Variables' */
        }

        /* End of Outputs for SubSystem: '<S519>/COMP Task - Reset Variables BC1' */

        /* Outputs for Enabled SubSystem: '<S519>/COMP Task - Rx_Set_Values_Check' incorporates:
         *  EnablePort: '<S584>/Enable'
         */
        if ((*rtd_Local_Ticks >= 88.0) && (*rtd_Local_Ticks < localC->Sum6)) {
          /* Logic: '<S584>/AND1' incorporates:
           *  Constant: '<S584>/Constant57'
           *  RelationalOperator: '<S584>/Equal'
           *  RelationalOperator: '<S584>/Equal13'
           */
          rtb_AND1_nj = ((*rtd_Local_Ticks == 88.0) && (*rtd_Board_ID == 8.0));

          /* Outputs for Enabled SubSystem: '<S584>/Reset Tx msg counter' */
          ResetTxmsgcounter(rtb_AND1_nj, rtd_Tx_msg_count_CAN1,
                            rtd_Tx_msg_count_CAN2);

          /* End of Outputs for SubSystem: '<S584>/Reset Tx msg counter' */
        }

        /* End of Outputs for SubSystem: '<S519>/COMP Task - Rx_Set_Values_Check' */

        /* Logic: '<S519>/NOT2' incorporates:
         *  Constant: '<S519>/Constant12'
         *  Constant: '<S519>/Constant16'
         *  Constant: '<S519>/Constant7'
         *  Constant: '<S519>/Constant8'
         *  DataStoreRead: '<S519>/Data Store Read6'
         *  DataStoreRead: '<S582>/Data Store Read'
         *  Logic: '<S519>/AND20'
         *  Logic: '<S519>/AND4'
         *  Logic: '<S519>/AND5'
        ...
        /* Outputs for Enabled SubSystem: '<S519>/COMP Task - Sync bc1 check' incorporates:
        ...
        if ((*rtd_Local_Ticks >= 40.0) && (*rtd_Local_Ticks < localC->Sum1) &&
          ...
          /* DataStoreRead: '<S585>/Data Store Read1' */
          rtb_DataStoreRead1_d3 = *rtd_New_Msg_Ready_CAN1;

          /* DataStoreRead: '<S585>/Data Store Read2' */
          rtb_DataStoreRead2_ph = *rtd_New_Msg_Ready_CAN2;

          /* DataStoreRead: '<S585>/Data Store Read' */
          rtb_DataStoreRead_hs = *rtd_Msg_Rx_CAN1;

          /* DataStoreRead: '<S585>/Data Store Read3' */
          rtb_DataStoreRead3 = *rtd_Msg_Rx_CAN2;

          /* RelationalOperator: '<S585>/Equal' */
          rtb_AND_ck = (*rtd_Local_Ticks == 40.0);

          /* RelationalOperator: '<S585>/Equal5' incorporates:
           *  Constant: '<S585>/Constant26'
           *  DataStoreRead: '<S585>/Data Store Read6'
           */
          rtb_AND1_e = (localDW->Role_ID != 1.0);

          /* Outputs for Enabled SubSystem: '<S585>/Process_Messages' incorporates:
          ...
          if (rtb_AND_ck && rtb_AND1_e) {
            ...
            /* Outputs for Enabled SubSystem: '<S636>/Demux message CAN1 and check coherence' */
            DemuxmessageCAN1andcheckcoher_d(rtb_DataStoreRead1_d3,
              &rtb_DataStoreRead_hs, 1.0,
              &localB->DemuxmessageCAN1andcheckcoher_o,
              &localDW->DemuxmessageCAN1andcheckcoher_o,
              &localDW->msg_count_DEBUG);

            /* End of Outputs for SubSystem: '<S636>/Demux message CAN1 and check coherence' */

            /* Outputs for Enabled SubSystem: '<S636>/Demux message CAN1 and check coherence1' */
            DemuxmessageCAN1andcheckcoher_h(rtb_DataStoreRead2_ph,
              &rtb_DataStoreRead3, 1.0, &localB->DemuxmessageCAN1andcheckcoher_k,
              &localDW->DemuxmessageCAN1andcheckcoher_k,
              &localDW->msg_count_DEBUG);

            /* End of Outputs for SubSystem: '<S636>/Demux message CAN1 and check coherence1' */

            /* Switch: '<S636>/Switch' incorporates:
             *  Constant: '<S585>/Constant'
             *  DataStoreWrite: '<S636>/Data Store Write'
             */
            ...
            /* Outputs for Enabled SubSystem: '<S636>/Desync calculation' incorporates:
            ...
            if (localDW->new_msg_Rx) {
               ...
               *  Constant: '<S640>/delay_estimation_1'
               *  Constant: '<S640>/delay_estimation_2'
               *  Product: '<S640>/Multiply'
               *  Product: '<S640>/Multiply1'
               *  Sum: '<S640>/Minus'
               *  Sum: '<S640>/Minus1'
               *  Sum: '<S640>/Sum'
               *  Sum: '<S640>/Sum1'
              ...
              /* End of Saturate: '<S640>/Saturation' */

              /* DataStoreWrite: '<S640>/Data Store Write1' */
              localDW->Desync_Ticks = Desync_Sync_bc1_ing_s;
            }

            /* End of Outputs for SubSystem: '<S636>/Desync calculation' */

            /* DataStoreWrite: '<S636>/Data Store Write3' incorporates:
          ...
          /* End of Outputs for SubSystem: '<S585>/Process_Messages' */
           ...
           *  Logic: '<S585>/NOT'
           */
          rtb_AND1_h = (rtb_AND_ck && (!rtb_AND1_e));

          /* Outputs for Enabled SubSystem: '<S585>/Reset Tx msg counter' */
          ResetTxmsgcounter(rtb_AND1_h, rtd_Tx_msg_count_CAN1,
                            rtd_Tx_msg_count_CAN2);

          /* End of Outputs for SubSystem: '<S585>/Reset Tx msg counter' */
        } else {
          if (localDW->COMPTaskSyncbc1check_MODE) {
            /* Disable for Enabled SubSystem: '<S585>/Process_Messages' */
            if (localDW->Process_Messages_MODE) {
        ...
        /* End of Outputs for SubSystem: '<S519>/COMP Task - Sync bc1 check' */

        /* Outputs for Enabled SubSystem: '<S519>/COMP Task - Update LT' incorporates:
         *  EnablePort: '<S586>/Enable'
         */
        if ((*rtd_Local_Ticks >= 44.0) && (*rtd_Local_Ticks < localC->Sum2) &&
            rtb_AND2_n) {
          /* RelationalOperator: '<S586>/Equal1' incorporates:
           *  Constant: '<S519>/Constant11'
           */
          rtb_AND_ck = (*rtd_Local_Ticks == 46.0);

          /* Outputs for Enabled SubSystem: '<S586>/LA - Ensemble precision' incorporates:
           *  EnablePort: '<S665>/Enable'
           */
          if ((*rtd_Local_Ticks == 44.0) && (1.0 != 0.0)) {
            /* DataStoreWrite: '<S665>/Data Store Write1' incorporates:
             *  Constant: '<S665>/Constant2'
             */
            localDW->Toggle_Pin_D10 = true;
          }

          /* End of Outputs for SubSystem: '<S586>/LA - Ensemble precision' */

          /* Logic: '<S586>/AND2' incorporates:
           *  Constant: '<S586>/Constant1'
           *  DataStoreRead: '<S586>/Data Store Read1'
           *  Logic: '<S586>/AND4'
           *  RelationalOperator: '<S586>/Equal3'
          ...
          /* Outputs for Enabled SubSystem: '<S586>/Local Time Update' */
          LocalTimeUpdate(rtb_AND2_o, 44.0, &localDW->BC1_Sync_processed,
                          &localDW->Desync_Positive, &localDW->Desync_Ticks,
                          rtd_Local_Ticks, rtd_Toggle_Pin_A0,
                          &localDW->Toggle_Pin_D10);

          /* End of Outputs for SubSystem: '<S586>/Local Time Update' */

          /* Outputs for Enabled SubSystem: '<S586>/Set Reset Board' incorporates:
          ...
          /* End of Outputs for SubSystem: '<S586>/Set Reset Board' */
        }

        /* End of Outputs for SubSystem: '<S519>/COMP Task - Update LT' */

        /* Logic: '<S519>/AND17' incorporates:
         *  Constant: '<S519>/Constant'
         *  Constant: '<S519>/Constant4'
         *  Constant: '<S519>/Constant6'
         *  Constant: '<S585>/Constant'
         *  Constant: '<S586>/Constant1'
         *  DataStoreRead: '<S519>/Data Store Read11'
         *  DataStoreRead: '<S586>/Data Store Read1'
         *  DataStoreWrite: '<S636>/Data Store Write2'
         *  Logic: '<S519>/AND'
         *  Logic: '<S519>/AND1'
         ...
         *  RelationalOperator: '<S519>/GreaterThan1'
         *  RelationalOperator: '<S519>/GreaterThan2'
         *  RelationalOperator: '<S519>/GreaterThan3'
         *  RelationalOperator: '<S519>/GreaterThan4'
         *  RelationalOperator: '<S519>/GreaterThan5'
        ...
        /* Outputs for Enabled SubSystem: '<S519>/COMM Task - Set_Values' incorporates:
        ...
        if ((rtb_DataStoreRead8_c >= 48.0) && (rtb_DataStoreRead8_c <
          ...
          /* RelationalOperator: '<S580>/Equal12' incorporates:
           *  Constant: '<S580>/Constant55'
           */
          rtb_AND_ck = (*rtd_Board_ID == 8.0);
          ...
          /* Outputs for Enabled SubSystem: '<S580>/Reception substasks' */
          Receptionsubstasks(rtb_NOT_e, 48.0, &localB->Receptionsubstasks_n,
          ...
          /* End of Outputs for SubSystem: '<S580>/Reception substasks' */

          /* Outputs for Enabled SubSystem: '<S580>/Transmission subtasks' incorporates:
          ...
          if (rtb_AND_ck) {
            ...
            /* RelationalOperator: '<S588>/Equal2' */
            rtb_AND_ck = (rtb_DataStoreRead_i > 48.0);

            /* Logic: '<S588>/AND' incorporates:
             *  Constant: '<S588>/Constant6'
             *  RelationalOperator: '<S588>/GreaterThan2'
             */
            rtb_AND_ex = (rtb_AND_ck && (*rtd_Tx_msg_count_CAN1 <= 7.0));

            /* Logic: '<S588>/AND1' incorporates:
             *  Constant: '<S588>/Constant7'
             *  RelationalOperator: '<S588>/GreaterThan3'
             */
            rtb_AND1_k = (rtb_AND_ck && (*rtd_Tx_msg_count_CAN2 <= 7.0));

            /* Outputs for Enabled SubSystem: '<S588>/Msg_Value_Data_Encoded' incorporates:
            ...
            if (rtb_DataStoreRead_i == 48.0) {
               ...
               *  RelationalOperator: '<S605>/LessThanOrEqual1'
               *  RelationalOperator: '<S605>/LessThanOrEqual2'
               *  Switch: '<S605>/Switch1'
               */
              if (1.0 < delta_a_set) {
                /* Switch: '<S605>/Switch' */
              ...
              /* RelationalOperator: '<S605>/GreaterThan' incorporates:
              ...
              /* DataTypeConversion: '<S605>/Cast' */
              rtb_Cast_k = rtb_AND_ck;

              /* Outputs for Atomic SubSystem: '<S605>/Bit Shift' */
              BitShift1(rtb_Cast_k, &localB->BitShift_ad);

              /* End of Outputs for SubSystem: '<S605>/Bit Shift' */
              ...
              /* End of Rounding: '<S605>/Fix1' */

              /* Sum: '<S605>/Plus' incorporates:
               *  DataTypeConversion: '<S605>/Cast1'
               *  DataTypeConversion: '<S605>/Cast2'
               */
               ...
               *  RelationalOperator: '<S606>/LessThanOrEqual1'
               *  RelationalOperator: '<S606>/LessThanOrEqual2'
               *  Switch: '<S606>/Switch1'
               */
              if (10.0 < v_set_s) {
                /* Switch: '<S606>/Switch' */
              ...
              /* RelationalOperator: '<S606>/GreaterThan' incorporates:
              ...
              /* DataTypeConversion: '<S606>/Cast' */
              rtb_Cast_p = rtb_AND_ck;

              /* Outputs for Atomic SubSystem: '<S606>/Bit Shift' */
              BitShift1(rtb_Cast_p, &localB->BitShift_n);

              /* End of Outputs for SubSystem: '<S606>/Bit Shift' */
              ...
              /* End of Rounding: '<S606>/Fix1' */

              /* Sum: '<S606>/Plus' incorporates:
               *  DataTypeConversion: '<S606>/Cast1'
               *  DataTypeConversion: '<S606>/Cast2'
               */
               ...
               *  RelationalOperator: '<S607>/LessThanOrEqual1'
               *  RelationalOperator: '<S607>/LessThanOrEqual2'
               *  Switch: '<S607>/Switch1'
               */
              if (1.0 < delta_f_set) {
                /* Switch: '<S607>/Switch' */
              ...
              /* RelationalOperator: '<S607>/GreaterThan' incorporates:
              ...
              /* DataTypeConversion: '<S607>/Cast' */
              rtb_Cast_kq = rtb_AND_ck;

              /* Outputs for Atomic SubSystem: '<S607>/Bit Shift' */
              BitShift1(rtb_Cast_kq, &localB->BitShift_c);

              /* End of Outputs for SubSystem: '<S607>/Bit Shift' */
              ...
              /* End of Rounding: '<S607>/Fix1' */

              /* Sum: '<S607>/Plus' incorporates:
               *  DataTypeConversion: '<S607>/Cast1'
               *  DataTypeConversion: '<S607>/Cast2'
               */
            ...
            /* End of Outputs for SubSystem: '<S588>/Msg_Value_Data_Encoded' */

            /* Outputs for Enabled SubSystem: '<S588>/Check msg transmission CAN1' */
            ...
            /* End of Outputs for SubSystem: '<S588>/Check msg transmission CAN1' */

            /* Outputs for Enabled SubSystem: '<S588>/Check msg transmission CAN2' */
            CheckmsgtransmissionCAN2(rtb_AND1_k, rtb_DataStoreRead_i, 48.0,
              localB->Plus_c, localB->Plus, localB->Plus_b, localB->Constant,
              &localB->CheckmsgtransmissionCAN2_c,
            ...
            /* End of Outputs for SubSystem: '<S588>/Check msg transmission CAN2' */
          } else {
            if (localDW->Transmissionsubtasks_MODE) {
              /* Disable for Enabled SubSystem: '<S588>/Check msg transmission CAN1' */
              if (localDW->CheckmsgtransmissionCAN1_a.CheckmsgtransmissionCAN1_MODE)
          ...
          /* End of Outputs for SubSystem: '<S580>/Transmission subtasks' */
        } else {
          if (localDW->COMMTaskSet_Values_MODE) {
            /* Disable for Enabled SubSystem: '<S580>/Reception substasks' */
            if (localDW->Receptionsubstasks_n.Receptionsubstasks_MODE) {
        ...
        /* End of Outputs for SubSystem: '<S519>/COMM Task - Set_Values' */

        /* Outputs for Enabled SubSystem: '<S519>/COMM Task - Sync bc 1' */
        ...
        /* End of Outputs for SubSystem: '<S519>/COMM Task - Sync bc 1' */
